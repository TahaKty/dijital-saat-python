...
lb_hr_txt = Label(clk, text="HOUR", font=("Times 20 bold"), bg="#0875B7", fg="white")
...
lb_mn_txt = Label(clk, text="MİNUTE", font=("Times 20 bold"), bg="#008EA4", fg="white")
...
lb_sc_txt = Label(clk, text="SECOND", font=("Times 20 bold"), bg="#06B4B8", fg="white")
